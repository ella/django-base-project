...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    'django.core.context_processors.auth', # because of validation
...
VERSIONS = {
    'djangobaseproject': djangobaseproject.__versionstr__,
    'djangobaselibrary': djangobaselibrary.__versionstr__,
}
